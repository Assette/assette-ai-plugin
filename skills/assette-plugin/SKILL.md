...
The eight **author-facing** skills —
...
public plugin. All fourteen live inside the hosted, B2C-gated MCP server and
...
6. Write the refreshed manifest back to `runtime.localSkillsManifest` with the
   **Write tool** — the full server catalog (every skill it returned + the
